 ...
 * {@link org.omnifaces.exceptionhandler.FullAjaxExceptionHandlerFactory}.
 *
 * @author Bauke Scholtz
 * @see org.omnifaces.exceptionhandler.FullAjaxExceptionHandlerFactory
 */
public class FullAjaxExceptionHandler extends ExceptionHandlerWrapper {
     ...
     * The default implementation delegates to {@link org.omnifaces.config.WebXml#findErrorPageLocation(Throwable)}.
     *
     * @param context   The involved faces context.
    ...
    protected String findErrorPageLocation(FacesContext context, Throwable exception) {
        return org.omnifaces.config.WebXml.INSTANCE.findErrorPageLocation(exception);
    }
    ...
    private boolean canRenderErrorPageView(FacesContext context, Throwable exception, String errorPageLocation) {
        if (context.getCurrentPhaseId() != PhaseId.RENDER_RESPONSE) {
            ...
            org.omnifaces.context.OmniPartialViewContext.getCurrentInstance(context).closePartialResponse();
            return false;
        }
    }
    ...
    private void resetResponse(FacesContext context) {
        ...
        org.omnifaces.context.OmniPartialViewContext.getCurrentInstance(context).resetPartialResponse();
